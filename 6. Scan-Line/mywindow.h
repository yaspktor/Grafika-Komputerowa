...
private:
    ...
    std::vector<int> ZnajdzPrzecieciaY(std::vector<std::pair<int, int>> punkty, int y);
    //void rysujLinie();
    ...
    //void punktyPrzecieciaY(int y, std::vector<std::pair<int, int>> punkty);
    void scanLine(std::vector<std::pair<int, int> > punkty);
