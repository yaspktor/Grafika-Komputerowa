...
private:
    ...
    void blend(QImage& Bg, QImage& Fg, float alpha, int mode, QImage& out);
    void mainAlphaBlending();
    // Deklaracje funkcji
    void czysc();
...
private slots:
    void slot_czysc();
    void slot_rysujObrazek(QListWidgetItem* item);
    void slot_blendMode(int index);
    void updateLabelAlpha(int value);
